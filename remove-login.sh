...
tput cup 6 30
echo -e "\x1b[42m TECH KNOWLEDGE LINUX WITH ARIJ \x1b[m"
tput cup 9 0
...
tput cup 15 0
echo -en "\e[93m Have you subscribe my channel,TECH KNOWLEDGE LINUX WITH ARIJ (y/n)? \e[m "
read answer

if [ "$answer" != "${answer#[Yy]}" ] ;then
tput cup 17 21
    echo -e "\e[42m Thankyou for subscribing my channel, TECH KNOWLEDGE LINUX WITH ARIJ \e[m"
else
tput cup 17 23
    echo -e "\x1b[41m Please subsrcibe my channel \x1b[m"
fi
tput cup 20 0
figlet -f slant "TECH KNOWLEDGE LINUX WITH ARIJ" |lolcat
echo " "
echo " "
